...
Pour toute question et remarque sur l'application, nous vous encourageons à utiliser les [issues](https://github.com/indsante/dico-snds/issues). Vous pouvez aussi nous envoyer un mail à **bigdata@sante.gouv.fr**.
